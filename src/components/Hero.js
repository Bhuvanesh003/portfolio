  ...
  return (
    <div className='text-white grid md:grid-cols-2'>
        <div className='flex flex-col py-20 md:py-40 mx-4 md:mx-[120px] '>
           ...
           <p className=''>'Im a Web Developer with extensive experience for over 5 years. My expertise is to create and Websites design, graphic design and many more...</p> 
        </div>
