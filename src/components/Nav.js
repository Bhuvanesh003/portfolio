  ...
  return (
    <div>
      <div className='  md:flex-row md:justify-around   md:items-center  text-white hidden md:flex'>
          ...
          {/* </div> */}
          <button className=' border-2 border-white hover:bg-white hover:text-black hover:text-bold focus:ring-4 focus:outline-none focus:ring-[#00df9a] px-6 py-2 md:w-auto md:block hidden'>Let's talk!</button>
      </div>
